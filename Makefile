...
prueba:  $(SRCDIR)/parser  $(TESTDIR)/PruebaBuena1.in $(TESTDIR)/PruebaBuena2.in $(TESTDIR)/PruebaBuena3.in $(TESTDIR)/PruebaBuena4.in $(TESTDIR)/PruebaBuena5.in $(TESTDIR)/PruebaMala1.in $(TESTDIR)/PruebaMala2.in $(TESTDIR)/PruebaMala3.in $(TESTDIR)/PruebaMala4.in
